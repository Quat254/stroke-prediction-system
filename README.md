...
Overview
The Stroke Prediction System is a machine learning-based web application designed to assess an individual's risk of stroke using health-related data. The system analyses key medical indicators and applies a trained machine learning model to generate predictions that may help support early risk awareness and preventative healthcare decisions.
...
Data Collection – Healthcare dataset containing patient risk indicators.
Data Preprocessing – Handling missing values and feature normalisation.
Feature Selection – Identifying key predictors such as age, hypertension, BMI, and glucose level.
Model Training – Training machine learning models using Scikit-learn.
Model Evaluation – Testing model accuracy and prediction performance.
Deployment – Integrating the trained model into a Flask web application.
Project Structure
stroke-prediction-system/
│
...
Implement data visualisation dashboards
